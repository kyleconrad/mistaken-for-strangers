<?php
/*
Single Post Template: Latest Track - Other Embed Template
Description: Template to use when embedding from Spotify, Soundcloud, etc. on Latest Tracks.
*/
?>
...
<section id="main-container" class="djax padding-bottom">
    ...
    <article class="post single-post latest-post">
        ...
        <div class="post-center btm-margin">
            <?php echo get_post_meta($post->ID, 'otherembed', true); ?>
        </div>
